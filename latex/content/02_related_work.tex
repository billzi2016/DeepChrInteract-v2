...
update rule, fully parallelisable at training), both stabilised via exponential gating.
Schmidinger~et~al.~\cite{bioxlstm} directly validate mLSTM on biological sequences
in Bio-xLSTM, where mLSTM-based DNA models outperform Transformer, Mamba, and HyenaDNA
on genomic benchmarks under both CLM and MLM pre-training objectives.
Bio-xLSTM supports context lengths up to 32k nucleotides via chunkwise parallel
processing, making it particularly well-suited to the 10\,kbp EPI sequences in this work.
