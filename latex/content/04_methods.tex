...
% ---- Architecture overview figure placeholder ----
\begin{figure}[H]
\centering
\begin{tikzpicture}[
  ...
  \node[box, fill=green!20,  right=2.8cm of en_enc, yshift=-0.6cm]
  ...
  \draw[arrow] (en_enc.east) -- ++(0.5,0) |- (fusion.west)
               node[near end, above, font=\scriptsize]{$\mathbf{h}_e$};
  \draw[arrow] (pr_enc.east) -- ++(0.5,0) |- (fusion.west)
